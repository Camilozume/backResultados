...
class InterfaceRepository(Generic[T]):
    ...
    #TODO verificar si este es necesario basado en el anterior
    ...
    #TODO merge with find_all in a new file
    ...
    # TODO create a function to process the for step
    ...
    def get_values_db_ref_from_list(self, list_: list) -> list:
        ...
        for item in list_:
            ...
            document_ref = collection_ref.find_one({'_id': _id})
            document_ref['_id'] = document_ref['_id'].__str__()
            processes_list.append(document_ref)
